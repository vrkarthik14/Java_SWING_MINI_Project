...
public class AddMedicine extends javax.swing.JPanel {
    ...
    public AddMedicine() {
        ...
        String[] col={"Medicine Name","Mfg. Date","Exp. Date","Purchase Price","Selling Price","Quantity"};
        ...
        {
            try {
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medicalmanagement","root","root");
        } catch (SQLException ex) {
            Logger.getLogger(PrintBill.class.getName()).log(Level.SEVERE, null, ex);
        }
            String sql1= "select * from medicalmanagement.medicine;";
            ...
            while(i==1)
            {
                if(rs1.next())
                {
                    ...
                    Medicine_Name= rs1.getString("medicinename");
                    //Manufacturer_Name=rs1.getString("Manufacturer_Name");
                    Mfg_Date=rs1.getString("manufacturedate");
                    Exp_Date= rs1.getString("expirydate");
                    Purchase_Price= rs1.getString("purchaseprice");
                    Selling_Price= rs1.getString("sellingprice");
                    Quantity=rs1.getString("quantity");
                
                    model.addRow(new Object[]{Medicine_Name,Mfg_Date,Exp_Date,Purchase_Price,Selling_Price,Quantity});
                }
                else
                {
                    i=0;
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/defaultpackage/expirydate.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/defaultpackage/currency-icon.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/defaultpackage/addmedicine.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medicine Name", "Mfg. Date", "Exp. Date", "Purchase Price", "Selling Price", "Quantity"
            }
        ) {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/defaultpackage/search.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            String tf6=jTextField6.getText();
            String tf7=jTextField7.getText();
            try {
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medicalmanagement","root","root");
        } catch (SQLException ex) {
            Logger.getLogger(PrintBill.class.getName()).log(Level.SEVERE, null, ex);
            ...
            String sql="INSERT INTO `medicine`(`medicinename`, `quantity`, `manufacturedate`, `expirydate`, `purchaseprice`, `sellingprice`) VALUES (?,?,?,?,?,?);";
